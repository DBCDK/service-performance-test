...
public class LogLineTest {
    ...
    private static String mockFile = new String("");

    @Test(timeout = 2_000L)
    public void testDistrib() throws Exception {
        System.out.println("testDistrib");
        LogLine logLine = LogLine.mappingScript(DISTRIB_LINE, mockFile);
    ...
    public void testStripTrackingId() throws Exception {
        ...
        LogLine logLine = LogLine.mappingScript(OK_LINE, mockFile);
    ...
    public void testNotRequest() throws Exception {
        ...
        LogLine logLine = LogLine.mappingScript(JVM_LINE, mockFile);
        assertThat(logLine.isValid(), is(false));
    }
    ...
    public void testNotSelect() throws Exception {
        ...
        LogLine logLine = LogLine.mappingScript(UPDATE_LINE, mockFile);
        assertThat(logLine.isValid(), is(false));
    }
